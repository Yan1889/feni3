...
curl -s --data-urlencode name_dm="Ilse-Fehling-Straße" --data-urlencode limit=20 --data-urlencode timeOffset=0 --data "language=de&type_dm=stop&mode=direct&dmLineSelectionAll=1&depType=STOPEVENTS&includeCompleteStopSeq=0&useRealtime=1&outputFormat=json" https://efa.mvv-muenchen.de/ng/XSLT_DM_REQUEST \
